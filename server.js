...
const backendRouter = require('./api/routes')
const defaultRouter = require('./api/routers/defaultRouter')

const { ErrorController } = require('./api/controllers')

const { MONGODB_URI, EXPRESS_PORT, BACKEND_BASEURL } = require('./api/config')
